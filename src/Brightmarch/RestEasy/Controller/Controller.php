...
namespace Brightmarch\RestEasy\Controller;

use Symfony\Component\HttpFoundation\Response;

use Brightmarch\RestEasy\Exception\HttpNotAcceptableException;
use Brightmarch\RestEasy\Exception\HttpNotExtendedException;
use Brightmarch\RestEasy\Exception\HttpUnauthorizedException;
use Brightmarch\RestEasy\Exception\HttpUnsupportedMediaTypeException;
